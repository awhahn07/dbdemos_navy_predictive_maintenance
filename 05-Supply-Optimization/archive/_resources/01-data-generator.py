...
dbutils.widgets.text('dbName',  'supply_chain_navy' , 'Database Name')
dbutils.widgets.text('cloud_storage_path',  '/Users/andrew.hahn@databricks.com/demos/retail', 'Storage Path')
...
#Added for compatability with calling scripts in Navy Demo
if catalog == 'hive_metastore':
  spark.sql("USE CATALOG hive_metastore")

# COMMAND ----------

print(f'Generating data at {cloud_storage_path}')
...
# demand_df_delta_path = 'dbfs:/Users/andrew.hahn@databricks.com/demos/retail/demand_df_delta'
...
# Execute the query and retrieve the result as a list of rows
result = spark.sql('SELECT current_catalog()').collect()

# Access the value of the column in each row and print it
for row in result:
    catalog = row[0]
