...
# Define the 6 sensors with their characteristics and failure distributions
...
### Core Sensor Generation Functions ###
...
def generate_turbine_data(turbine_id, sensors=None, sample_size=None, turbine_count=None, frequency_sec=None, base_time=None):
    ...
    rd = random.Random()
    if not isinstance(turbine_id, int):
...
### Spark DataFrame Generation Functions ###
